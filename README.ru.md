...
Программа для просмотра фотоархива с автоматическим распознаванием мест и лиц, которую можно поставить на свой сервер или NAS. Но пока лучше не ставить — это альфа версия.

![Таймлайн](screenshots/nostalgator.png)
![Ифнормация о фото](screenshots/photo-details.png)
![Настройки событий](screenshots/event-settings.png)

# ВИНМАНИЕ

Тут сильно навайбкожено. Даже это readme.
...
| `FACE_MATCH_THRESHOLD` | Порог косинусного сходства для сопоставления лиц (по умолчанию `0.55`) |
